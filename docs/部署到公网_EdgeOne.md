...
> **平台已改版，入口变了**：EdgeOne Pages 于 2026 年 6 月更名为 **EdgeOne Makers**。
> 官网 `pages.edgeone.ai` 现在是产品介绍页，**真正的控制台在腾讯云控制台里**。
...
结论：**课堂现场演示用预览链接完全够**；如果想让老师过几天也能随时打开，
就得买个域名绑上（课程项目量级，几十块一年的 `.top` / `.xyz` 足够，
选「全球可用区（不含中国大陆）」不需要备案）。
