...
INSERT INTO lab_items (item_code, item_name, item_category, unit, reference_range, price, status) VALUES
('WBC',  '白细胞计数', '血常规', '10^9/L', '3.5-9.5', 0.00, '启用'),
('RBC',  '红细胞计数', '血常规', '10^12/L', '3.8-5.8', 0.00, '启用'),
('HGB',  '血红蛋白', '血常规', 'g/L', '115-175', 0.00, '启用'),
('PLT',  '血小板计数', '血常规', '10^9/L', '125-350', 0.00, '启用'),
('NEUT',  '中性粒细胞百分比', '血常规', '%', '40-75', 8.00, '启用'),
('LYMP',  '淋巴细胞百分比', '血常规', '%', '20-50', 8.00, '启用'),
('HCT',  '红细胞压积', '血常规', '%', '40-50', 8.00, '启用'),
('MCV',  '平均红细胞体积', '血常规', 'fL', '82-100', 8.00, '启用'),
('MCH',  '平均血红蛋白含量', '血常规', 'pg', '27-34', 8.00, '启用'),
('MCHC',  '平均血红蛋白浓度', '血常规', 'g/L', '316-354', 8.00, '启用'),
('URPRO',  '尿蛋白', '尿常规', '定性', '阴性', 0.00, '启用'),
('URGLU',  '尿糖', '尿常规', '定性', '阴性', 0.00, '启用'),
('URBLD',  '尿潜血', '尿常规', '定性', '阴性', 0.00, '启用'),
('URLEU',  '尿白细胞', '尿常规', '定性', '阴性', 6.00, '启用'),
('URBIL',  '尿胆红素', '尿常规', '定性', '阴性', 6.00, '启用'),
('URKET',  '尿酮体', '尿常规', '定性', '阴性', 6.00, '启用'),
('URNIT',  '亚硝酸盐', '尿常规', '定性', '阴性', 6.00, '启用'),
('URURO',  '尿胆原', '尿常规', '定性', '阴性', 6.00, '启用'),
('URSG',  '尿比重', '尿常规', 'NULL', '1.003-1.030', 6.00, '启用'),
('URPH',  '尿酸碱度', '尿常规', 'NULL', '4.5-8.0', 6.00, '启用'),
('ALT',  '谷丙转氨酶', '肝功能', 'U/L', '9-50', 0.00, '启用'),
('AST',  '谷草转氨酶', '肝功能', 'U/L', '15-40', 0.00, '启用'),
('TBIL',  '总胆红素', '肝功能', 'umol/L', '3.4-20.5', 0.00, '启用'),
('DBIL',  '直接胆红素', '肝功能', 'umol/L', '0-6.8', 12.00, '启用'),
('TP',  '总蛋白', '肝功能', 'g/L', '65-85', 12.00, '启用'),
('ALB',  '白蛋白', '肝功能', 'g/L', '40-55', 12.00, '启用'),
('ALP',  '碱性磷酸酶', '肝功能', 'U/L', '45-125', 12.00, '启用'),
('GGT',  'γ-谷氨酰转移酶', '肝功能', 'U/L', '10-60', 12.00, '启用'),
('CREA',  '肌酐', '肾功能', 'umol/L', '57-111', 0.00, '启用'),
('BUN',  '尿素氮', '肾功能', 'mmol/L', '3.1-8.8', 0.00, '启用'),
('UA',  '尿酸', '肾功能', 'umol/L', '208-428', 18.00, '启用'),
('CYSC',  '胱抑素C', '肾功能', 'mg/L', '0.6-1.2', 25.00, '启用'),
('FBG',  '空腹血糖', '血糖血脂', 'mmol/L', '3.9-6.1', 0.00, '启用'),
('TC',  '总胆固醇', '血糖血脂', 'mmol/L', '2.8-5.2', 0.00, '启用'),
('TG',  '甘油三酯', '血糖血脂', 'mmol/L', '0.4-1.7', 0.00, '启用'),
('HDL',  '高密度脂蛋白胆固醇', '血糖血脂', 'mmol/L', '1.0-1.7', 10.00, '启用'),
('LDL',  '低密度脂蛋白胆固醇', '血糖血脂', 'mmol/L', '0-3.4', 10.00, '启用'),
('CRP',  'C反应蛋白', '炎症标志物', 'mg/L', '0-8', 0.00, '启用'),
('PCT',  '降钙素原', '炎症标志物', 'ng/mL', '0-0.5', 30.00, '启用'),
('ESR',  '血沉', '炎症标志物', 'mm/h', '0-20', 15.00, '启用'),
('FOB',  '粪便隐血', '粪便常规', '定性', '阴性', 10.00, '启用'),
('FWC',  '粪白细胞', '粪便常规', '定性', '阴性', 10.00, '启用'),
('FRC',  '粪红细胞', '粪便常规', '定性', '阴性', 10.00, '启用'),
('K',  '钾', '电解质', 'mmol/L', '3.5-5.3', 25.00, '启用'),
('NA',  '钠', '电解质', 'mmol/L', '137-147', 25.00, '启用'),
('CL',  '氯', '电解质', 'mmol/L', '99-110', 25.00, '启用'),
